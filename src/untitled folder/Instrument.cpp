...
/*
 Get the last block
 */
Block * Instrument:: getLastBlock(){ return m_lastBlock; }
...
Block * Instrument::currentPlayingBlock()
{
	return m_cursor->currentBlock();
}
void Instrument::slideCursor(Direction direction){
...
{
	m_cursor->sendOSCMessage(MIDINote, velocity);
}
